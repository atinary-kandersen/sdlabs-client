...
import WatchedExperiments from '../watched-experiences/WatchedExperiments';
  ...
  return (
    <header className={styles.header}>
      <div className={classNames(styles.headerSectionLeft, 'wa-gap-m')}>
        ...
        <img
          src="http://atinary.com/wp-content/uploads/2024/02/ATINARY_LOGO_LONG_DARK.png"
          className={styles.atinaryLogo}
        />
        <span className={styles.customer}>Givaudan</span>
      </div>
